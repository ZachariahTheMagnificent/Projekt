...
namespace Vk
{
        ...
        p_instance_( p_instance )
    {
        ...
        debug_report_callback_handle_ = p_instance_->create_debug_report_callback( create_info );
    }
    ...
    DebugReport::~DebugReport( )
    {
        if( debug_report_callback_handle_ != VK_NULL_HANDLE )
            debug_report_callback_handle_ = p_instance_->destroy_debug_report_callback( debug_report_callback_handle_ );
    }
    ...
    DebugReport &DebugReport::operator=( DebugReport &&debug_report ) noexcept
    {
        if( this != &debug_report )
        {
            ...
            debug_report_callback_handle_ = debug_report.debug_report_callback_handle_;
            debug_report.debug_report_callback_handle_ = VK_NULL_HANDLE;
